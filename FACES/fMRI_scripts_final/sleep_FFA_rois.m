function sleep_FFA_rois

subs = [];
load sub_list
rimg = load_nii('/data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/RFFA_roi.nii')
limg = load_nii('/data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/LFFA_roi.nii')
...
for pdx = 1:size(subs,1)
     try
        ...
        for ses=1:2
            cd(['/data/stress/FACES_BIDS/ds201_R1.0.0/GLMs/glm_t-tests/sub-' num2str(subs(pdx)) '_' num2str(s(ses))]);
            m=load_nii('mask.nii');
...
cd /data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/FFA_csv
