...
subs = [];
load sub_list
rimg = load_nii('/data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/right_amyg.nii')
limg = load_nii('/data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/left_amyg.nii')
...
cd /data/stress/FACES_BIDS/ds201_R1.0.0/ROIs/amyg_csv
