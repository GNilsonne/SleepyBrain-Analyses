...
matlabbatch{1}.spm.util.voi.name = 'amygdala_left';
matlabbatch{1}.spm.util.voi.roi{1}.sphere.centre = [-20 -4 -16];
...
ppiflag = 'ppi';
VOI_name = ['/data/stress/FACES_BIDS/ds201_R1.0.0/GLMs/glm_t-tests/' pt '/VOI_amygdala_left_1.mat'];
design = [1 1 1; 2 1 -1];
PPI_name = 'HA_AN_NE';
...
mkdir PPI_amy_L
movefile(['PPI_' PPI_name '.mat'], ['PPI_amy_L/PPI_' PPI_name '.mat'])
cd PPI_amy_L
...
job.dir = {['/data/stress/FACES_BIDS/ds201_R1.0.0/GLMs/glm_t-tests/' pt '/PPI_amy_L']}
