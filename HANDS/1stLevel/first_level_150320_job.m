...
for i = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/HANDS_AGE/45Slices/', subject_session, '/1st_level_150320')); 
    directory = cellstr(strcat('/data/stress/HANDS_AGE/45Slices/', subject_session, '/1st_level_150320'));

    onsets = dir(strcat('/data/stress/HANDS_AGE/Onsetfiles_150319/', subject_session, '*.mat'));
    onsets = arrayfun(@(file) strcat('/data/stress/HANDS_AGE/Onsetfiles_150319/', file.name), onsets, 'UniformOutput', false);
...
for i = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/HANDS_AGE/46Slices/', subject_session, '/1st_level_150320')); 
    directory = cellstr(strcat('/data/stress/HANDS_AGE/46Slices/', subject_session, '/1st_level_150320')); 
