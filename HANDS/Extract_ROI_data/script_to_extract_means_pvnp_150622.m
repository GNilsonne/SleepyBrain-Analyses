...
for i = 1:length(folders)
    ...
    ses = subject_session(5);
    session = str2num(ses);
    LammMask = mean(spm_summarise(strcat('/data/stress/HANDS_AGE/46Slices/', subject_session, '/1st_level_150320/con_0003.nii'), struct('def', 'mask', 'spec', '/data/stress/HANDS_AGE/ROIsFromLamm/pic_p_np_00001.nii')));
