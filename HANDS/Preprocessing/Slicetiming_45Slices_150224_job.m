% Preprocessing is done through separate scripts for every step. The following
...
% structural), structural segmentation, DARTEL template and normalisation to MNI
% + smoothing.
%-----------------------------------------------------------------------
% Script to slice time correct all the young and older subjects/sessions with 45 slices,
...
for i = 1:length(folders)
    ...
    files = dir(strcat('/data/stress/HANDS_AGE/45Slices/', subject_session, '/2*.nii'));
