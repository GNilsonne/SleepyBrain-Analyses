...
% Thus, in this case, icatb_batch_file_run('/data/stress/Resting_State/GIFT_151114/Input_data_subjects_2.m')
...
selectedSubjects = {%%REDACTED%%};  % naming for subjects s1 refers to subject 1, s2 means subject 2. Use cell array convention even in case of one subject one session
...
%% Files were selected here, but this section has been redacted before publishing in order to preseve participants' anonymity.
...
outputDir = '/data/stress/Resting_State/GIFT_151114';
...
maskFile = '/data/stress/Resting_State/WD_DPARSF_151001/Masks/AllResampled_GreyMask_02_91x109x91.nii'; 
