...
for i = 1:length(folders)
    ...
    VOI = dir(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/1st_level_151208/VOI_Amygdala_L_1.mat'));
    ...
    matlabbatch{1}.spm.stats.ppi.type.ppi.u = [4 1 -1; 6 1 1];
    matlabbatch{1}.spm.stats.ppi.name = 'Amygdala_L_Down_maintain';
...
for j = 1:length(folders)
    ...
    VOI = dir(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/1st_level_151208/VOI_Amygdala_L_1.mat'));
...
for k = 1:length(folders)
    ...
    VOI = dir(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/1st_level_151208/VOI_Amygdala_L_1.mat'));
