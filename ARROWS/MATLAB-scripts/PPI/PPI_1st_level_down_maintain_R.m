...
for i = 23:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_R_Down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'));
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.regress(3).name = 'Down>maintain';
    ...
    matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Down>maintain';
...
for j = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_R_down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'));
...
for k = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/1st_level_151208/PPI_Amygdala_R_down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_R/PPI_Amygdala_R_Down_maintain.mat'));
