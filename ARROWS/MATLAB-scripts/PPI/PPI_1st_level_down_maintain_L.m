...
for i = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_L'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_L'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_L_Down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'));
...
for j = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_L'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_L'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_L_down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'));
...
for k = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_L'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_L'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/1st_level_151208/PPI_Amygdala_L_down_maintain.mat'), strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Down_maintain_L/PPI_Amygdala_L_Down_maintain.mat'));
