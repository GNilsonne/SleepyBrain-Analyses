...
for i = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Neg_neu_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Neg_neu_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_R_Neg_neu.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/45Slices/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'));
...
for j = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Neg_neu_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Neg_neu_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/1st_level_151208/PPI_Amygdala_R_Neg_neu.mat'), strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'));
...
for k = 1:length(folders)
    ...
    mkdir(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Neg_neu_R'));
    directory = cellstr(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Neg_neu_R'));
    copyfile(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/1st_level_151208/PPI_Amygdala_R_Neg_neu.mat'), strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'))
    load(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/PPI_180621_Neg_neu_R/PPI_Amygdala_R_Neg_neu.mat'));
