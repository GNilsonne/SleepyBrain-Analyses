...
% + SMOOTH.
%-----------------------------------------------------------------------
% Script to slice time correct all the young subjects/sessions with 46 slices,
% ARROWS experiment. Subjects/sessions with 45 slices are done separately.
...
for i = 1:length(folders)
    ...
    files = dir(strcat('/data/stress/ARROWS/ARROWS_Young2/46Slices/', subject_session, '/2*.nii'));
