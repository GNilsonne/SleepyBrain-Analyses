...
for i = 1:length(folders)
    ...
    anatomical = dir(strcat('/data/stress/Structural_HANDS_ARROWS_Young/', subject, '*001.nii'));
    structural = arrayfun(@(file) strcat('/data/stress/Structural_HANDS_ARROWS_Young/', file.name), anatomical, 'UniformOutput', false);
    mean = dir(strcat('/data/stress/ARROWS/ARROWS_Young/45Slices/', subject_session, '/m*.nii'));
    meanEPI = arrayfun(@(file) strcat('/data/stress/ARROWS/ARROWS_Young/45Slices/', subject_session, '/', file.name), mean, 'UniformOutput', false);
    files = dir(strcat('/data/stress/ARROWS/ARROWS_Young/45Slices/', subject_session, '/', 'ua*.nii'));
    data = arrayfun(@(file) strcat('/data/stress/ARROWS/ARROWS_Young/45Slices/', subject_session, '/', file.name), files, 'UniformOutput', false);
...
for j = 1:length(folders)
    ...
    anatomical = dir(strcat('/data/stress/Structural_HANDS_ARROWS_Young/', subject, '*001.nii'));
    structural = arrayfun(@(file) strcat('/data/stress/Structural_HANDS_ARROWS_Young/', file.name), anatomical, 'UniformOutput', false);
    mean = dir(strcat('/data/stress/ARROWS/ARROWS_Young/46Slices/', subject_session, '/m*.nii'));
    meanEPI = arrayfun(@(file) strcat('/data/stress/ARROWS/ARROWS_Young/46Slices/', subject_session, '/', file.name), mean, 'UniformOutput', false);
    files = dir(strcat('/data/stress/ARROWS/ARROWS_Young/46Slices/', subject_session, '/', 'ua*.nii'));
    data = arrayfun(@(file) strcat('/data/stress/ARROWS/ARROWS_Young/46Slices/', subject_session, '/', file.name), files, 'UniformOutput', false);
