...
for i = 1:length(folders)
    ...
    matlabbatch{1}.spm.stats.results.conspec.mask.image.name = {'/data/stress/ARROWS/RegionsOfInterest/dlPFCR_mask.nii,1'};
    ...
    copyfile('spm_2015Dec22.ps', strcat('/data/stress/ARROWS/dlPFC_R/', subject_session, '.ps'))
