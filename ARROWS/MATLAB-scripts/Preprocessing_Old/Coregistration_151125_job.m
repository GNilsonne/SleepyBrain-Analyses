...
for i = 1:length(folders)
    ...
    mean = dir(strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/m*.nii'));
    meanEPI = arrayfun(@(file) strcat('/data/stress/ARROWS/ARROWS_Old/', subject_session, '/', file.name), mean, 'UniformOutput', false);
