...
for j = 35:length(folders)
    ...
    matlabbatch{j+i}.spm.tools.dartel.mni_norm.template = {'/data/stress/Structural_ARROWS_All/Template_6.nii'};
...
for k = 1:length(folders)
    ...
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.template = {'/data/stress/Structural_ARROWS_All/Template_6.nii'};
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.data.subj(1).flowfield = flowfield;
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.data.subj(1).images = data;
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.vox = [NaN NaN NaN];
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.bb = [NaN NaN NaN
                                                   NaN NaN NaN];
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.preserve = 0;
    matlabbatch{k+j+i}.spm.tools.dartel.mni_norm.fwhm = [8 8 8];
end
