...
for i = 1:length(folders)
    ...
    matlabbatch{1}.spm.stats.results.conspec.mask.image.name = {'/data/stress/ARROWS/RegionsOfInterest/dlPFCL_mask.nii,1'};
    ...
    copyfile('spm_2015Dec22.ps', strcat('/data/stress/ARROWS/dlPFC_L/', subject_session, '.ps'))
